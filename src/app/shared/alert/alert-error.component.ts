...
export class AlertErrorComponent implements OnDestroy {
  ...
  //   this.errorListener = eventManager.subscribe('syspentestApp.error',
  //     (response: JhiEventWithContent<AlertError>) => {
  //     const errorResponse = response.content;
  //     this.addErrorAlert(errorResponse.message, errorResponse.key, errorResponse.params);
  //   });
  //
  //   this.httpErrorListener = eventManager.subscribe('syspentestApp.httpError', (response: JhiEventWithContent<HttpErrorResponse>) => {
  ...
  //             const fieldName = translateService.instant('syspentestApp.' + fieldError.objectName + '.' + convertedField);

...
export class SubheaderService {
   ...
   */
  setBreadcrumbs(breadcrumbs: Breadcrumb[] | any[]): void {
   ...
   * param breadcrumbs
   */
  appendBreadcrumbs(breadcrumbs: Breadcrumb[] | any[]): void {
